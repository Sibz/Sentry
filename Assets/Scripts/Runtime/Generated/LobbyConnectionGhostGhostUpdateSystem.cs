...
public class LobbyConnectionGhostGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<LobbyConnectionGhostSnapshotData> ghostSnapshotDataType;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<LobbyConnectionGhostSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<LobbyConnectionGhostSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
                ComponentType.ReadOnly<PredictedGhostComponent>(),
            }
        });
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<LobbyConnectionGhostSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<LobbyConnectionGhostSnapshotData>(true),
...
public partial class LobbyConnectionGhostGhostSpawnSystem : DefaultGhostSpawnSystem<LobbyConnectionGhostSnapshotData>
{
}
